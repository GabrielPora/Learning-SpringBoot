...
import com.crudinit.repository.PostRepository;
...
public class DataLoader {
	...
	private void createAuthors() {
		Author jv = new Author("Joe","Vega","jvega@crudinit.com");
		authorRepository.save(jv);
		Author av = new Author("Andy","Vega","avega@crudinit.com");
		authorRepository.save(av);
		Author kv = new Author("Katie","Vega","kvega@crudinit.com");
